...
import system.entity.SysUserDeptExample.Criteria;
import system.entity.SysUserDeptExample.Criterion;
import org.apache.ibatis.jdbc.SQL;

import java.util.List;
import java.util.Map;

public class SysUserDeptSqlProvider {
    ...
    public String updateByPrimaryKeySelective(SysUserDept record) {
        SQL sql = new SQL();
        sql.UPDATE("sys_user_dept");
